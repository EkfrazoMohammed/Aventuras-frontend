...
const Step3Content = ({ data, coupons, setData }) => {
  ...
  const handleCouponChange = (value) => {
    ...
    // console.log("selectedCoupon:", selectedCoupon.attributes.code);
  ...
  const handlePaymentSubmit = async (e) => {
    ...
    if (userData && userData.jwt) {
      ...
      try {
        ...
        // const res = await axios.post("http://https://aventuras.co.in/api/v1/4000/api/v1/payment/initiate_test_upi_card_payment",ob)
