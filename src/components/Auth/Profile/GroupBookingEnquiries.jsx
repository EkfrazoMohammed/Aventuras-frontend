...
const GroupBookingEnquiries = () => {
  const [data,setData]=useState([])

  const [loading,setLoading]=useState(true)

  const fetchData=async ()=>{
  let url="https://admin.aventuras.co.in/api/group-tour-enquiries?populate=deep&sort=createdAt:desc"
          try{
            setLoading(true)
...
const filteredData = responseData.filter(item => {
  ...
  return (
    ...
    <div className="activities-heading">My Group Booking Enquiries</div>
...
export default GroupBookingEnquiries